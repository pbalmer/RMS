...
public class Label {
    ...
    @XmlElementRef(name = "LabelText", namespace = "urn:objects.ws.rightnow.com/v1_2", type = JAXBElement.class)
    ...
    public void setLabelText(JAXBElement<String> value) {
        this.labelText = ((JAXBElement<String> ) value);
    }
    ...
    public void setValidNullFields(JAXBElement<LabelNullFields> value) {
        this.validNullFields = ((JAXBElement<LabelNullFields> ) value);
    }
