...
public class Address {
    ...
    @XmlElementRef(name = "City", namespace = "urn:objects.ws.rightnow.com/v1_2", type = JAXBElement.class)
    protected JAXBElement<String> city;
    @XmlElementRef(name = "Country", namespace = "urn:objects.ws.rightnow.com/v1_2", type = JAXBElement.class)
    protected JAXBElement<NamedID> country;
    @XmlElementRef(name = "PostalCode", namespace = "urn:objects.ws.rightnow.com/v1_2", type = JAXBElement.class)
    protected JAXBElement<String> postalCode;
    @XmlElementRef(name = "StateOrProvince", namespace = "urn:objects.ws.rightnow.com/v1_2", type = JAXBElement.class)
    protected JAXBElement<NamedID> stateOrProvince;
    @XmlElementRef(name = "Street", namespace = "urn:objects.ws.rightnow.com/v1_2", type = JAXBElement.class)
    ...
    public void setCountry(JAXBElement<NamedID> value) {
        this.country = ((JAXBElement<NamedID> ) value);
    }
    ...
    public void setStateOrProvince(JAXBElement<NamedID> value) {
        this.stateOrProvince = ((JAXBElement<NamedID> ) value);
    }
    ...
    public void setValidNullFields(JAXBElement<AddressNullFields> value) {
        this.validNullFields = ((JAXBElement<AddressNullFields> ) value);
    }
